...
?>
    ...
    <p class="backdropped"><b>Theme settings</b> be selected by registered users, by hovering over the top-left part of any window and clicking on the painters palette icon that then appears.</p>
