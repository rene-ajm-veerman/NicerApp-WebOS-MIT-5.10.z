...
;
     ...
     */
        ...
        if (!divID) var c = $('body')[0]; else var c = $(divID)[0];
debugger;

        na.site.startTooltips();


        $('.vividDialog, .vividDialogPopup', c).each(function(idx,el){
        ...
        $('.vividButton4, .vividButton, .vividButton_icon_50x50_siteTop, .vividButton_icon_50x50', c).each(function(idx,el){
