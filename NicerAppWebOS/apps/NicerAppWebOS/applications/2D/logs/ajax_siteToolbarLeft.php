...
//if ($appRec['page']=='index') {
    ...
    echo PHP_EOL;
    echo '<script type="text/javascript">setTimeout(function() { $(\'#siteToolbarLeft\').css({width:70}); na.desktop.settings.visibleDivs.push(\'#siteToolbarLeft\');na.desktop.resize();},1000);</script>';
