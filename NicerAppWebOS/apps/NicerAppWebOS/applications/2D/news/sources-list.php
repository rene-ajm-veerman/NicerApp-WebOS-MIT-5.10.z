...
$newsApp3_dataSources['RSS_list'] = array (
    'Actualités françaises' => [
        'leMonde.fr' => [
            'Actualités' => [
                ...
                'En continue' => 'https://www.lemonde.fr/rss/en_continu.xml',
                'Vidéos' => 'https://www.lemonde.fr/videos/rss_full.xml',
                'Portfolios' => 'https://www.lemonde.fr/photo/rss_full.xml',
                'Les plus lus' => 'https://www.lemonde.fr/rss/plus-lus.xml',
                'Les plus partagés' => 'https://www.lemonde.fr/rss/plus-partages.xml'
            ],
            'International' => [
                'La une International' => 'https://www.lemonde.fr/international/rss_full.xml',
            ...
            'Economie' => [
                'La une Economie' => 'https://www.lemonde.fr/economie/rss_full.xml',
                'Entreprises' => 'https://www.lemonde.fr/entreprises/rss_full.xml',
                'Argent' => 'https://www.lemonde.fr/argent/rss_full.xml',
                'Économie française' => 'https://www.lemonde.fr/economie-francaise/rss_full.xml',
                ...
                'Médias' => 'https://www.lemonde.fr/actualite-medias/rss_full.xml'
            ],
            'Culture' => [
                'La une Culture' => 'https://www.lemonde.fr/culture/rss_full.xml',
                'Cinéma' => 'https://www.lemonde.fr/cinema/rss_full.xml',
                'Musiques' => 'https://www.lemonde.fr/musiques/rss_full.xml',
                'Télévision et radio' => 'https://www.lemonde.fr/televisions-radio/rss_full.xml',
                'Le Mondes des livres' => 'https://www.lemonde.fr/livres/rss_full.xml',
                'Arts' => 'https://www.lemonde.fr/arts/rss_full.xml',
                'Scènes' => 'https://www.lemonde.fr/scenes/rss_full.xml'
            ],
            'Sport' => [
                'La une Sport' => 'https://www.lemonde.fr/sport/rss_full.xml',
            ...
            'Planète' => [
                'La une Planète' => 'https://www.lemonde.fr/planete/rss_full.xml',
                'Climat' => 'https://www.lemonde.fr/climat/rss_full.xml',
                'Agriculture' => 'https://www.lemonde.fr/agriculture/rss_full.xml',
                'Environment' => 'https://www.lemonde.fr/afrique-climat-et-environnement/rss_full.xml'
            ],
            'Pixels' => [
                'La une Pixels' => 'https://www.lemonde.fr/pixels/rss_full.xml',
                'Jeux vidéo' => 'https://www.lemonde.fr/jeux-video/rss_full.xml',
                'Culture web' => 'https://www.lemonde.fr/cultures-web/rss_full.xml'
            ],
            'Sciences' => [
                'La une Sciences' => 'https://www.lemonde.fr/sciences/rss_full.xml',
                'Espace' => 'https://www.lemonde.fr/espace/rss_full.xml',
                'Biologie' => 'https://www.lemonde.fr/biologie/rss_full.xml',
                'Médecine' => 'https://www.lemonde.fr/medecine/rss_full.xml',
                'Physique' => 'https://www.lemonde.fr/physique/rss_full.xml',
                'Santé' => 'https://www.lemonde.fr/sante/rss_full.xml'
            ],
            'Opinions' => [
                'La une Opinions' => 'https://www.lemonde.fr/idees/rss_full.xml',
                'éditoriaux' => 'https://www.lemonde.fr/editoriaux/rss_full.xml',
                'chroniques' => 'https://www.lemonde.fr/chroniques/rss_full.xml',
                'tribunes' => 'https://www.lemonde.fr/tribunes/rss_full.xml'
            ],
            'M le mag' => [
                'La une M le mag' => 'https://www.lemonde.fr/m-le-mag/rss_full.xml',
                'L’époque' => 'https://www.lemonde.fr/m-perso/rss_full.xml',
                'Styles' => 'https://www.lemonde.fr/m-styles/rss_full.xml',
                'Gastronomie' => 'https://www.lemonde.fr/gastronomie/rss_full.xml',
                'Recettes du Monde' => 'https://www.lemonde.fr/les-recettes-du-monde/rss_full.xml',
                'Sexo' => 'https://www.lemonde.fr/sexo/rss_full.xml'
            ],
            'Guide d’achat' => [
                'Les derniers guides' => 'https://www.lemonde.fr/guides-d-achat/rss_full.xml'
            ]
        ]
    ],
    ...
    'English News' => array (
        'World Headlines' => array (
            'TV' => 'https://feeds.feedburner.com/FreeTvFromAllOverTheWorld',
...
// India:
        ...
        'Topics' => array (
            ...
            'Business' => array (
                ...
                'spGlobal.com' => [
                    'All Indeces' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=all-indices',
                    'Methodologies' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=methodologies',
                    'Research' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=research',
                    'Commentary' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=market-commentary',
                    'Daily Index Insights' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=daily-index-insights',
                    'Education' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=education',
                    'Performance Reports' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=performance-reports',
                    'SPIVA(R)' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=spiva',
                    'IndexTV' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=index-tv',
                    'Corporate News' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=corporate-news',
                    'Index Launches' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=index-launches',
                    'Index Announcements' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=index-news-announcements',
                    'Consultations' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=consultations',
                    'Home Price Indeces' => 'https://www.spglobal.com/spdji/en/rss/rss-details/?rssFeedName=sp-cotality-case-shiller-home-price-indices'
                ],
                'MarketWatch.com' => [
                        ...
                        'Breaking News Headlines' => 'http://feeds.marketwatch.com/marketwatch/bulletins',
